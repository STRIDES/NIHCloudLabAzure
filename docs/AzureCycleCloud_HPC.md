...
Fill out the neccassary information required, you will need to configure a custom role for Azure CycleCloud to find your subscription. Here is [documentation](https://github.com/STRIDES/NIHCloudLabAzure/blob/custom_role_doc/docs/Create_Custom_Role_AzureHPC.md) on how to create a custom role for Azure Cycle Cloud.
