...
Virtual machines (VMs) on Azure are like virtual computers that you access via SSH and which start as (nearly) completly blank slates. More information on Vms can be found [here](https://azure.microsoft.com/en-us/products/virtual-machines/#overview). To view the different types of VMs and their cost check out the [Virtual Machine Series](https://azure.microsoft.com/en-us/pricing/details/virtual-machines/series/) 
