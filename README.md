...
To see more information on how to manage resource groups, visit [Managing Resource Groups](/docs/resource_groups.md).
...
[Azure Machine Learning studio](https://learn.microsoft.com/en-us/azure/machine-learning/overview-what-is-azure-machine-learning) is one of the preferred tools when using Azure Machine learning. ML studio allows for you to run your own code in managed Jupyter notebooks. Follow the [Quickstart](https://learn.microsoft.com/en-us/azure/machine-learning/quickstart-run-notebooks) page to begin running Jupyter Notebooks in studio. Make sure you start by creating a [workspace and a VM](https://learn.microsoft.com/en-us/azure/machine-learning/quickstart-create-resources). You can also watch [this video](https://github.com/microsoft/genomicsnotebook#1-prerequisites) for another perspective. Once you have a an environment running, you can clone this repository and begin testing the notebooks available in the [tutorials section](/tutorials/notebooks). 
